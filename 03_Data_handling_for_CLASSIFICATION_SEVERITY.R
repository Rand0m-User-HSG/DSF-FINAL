#### Introduction ####
# In this script we create a dataset specifically for severity tasks (classication tasks)
...
Y_vector = as.integer(df_class$AccidentSeverityCategory)
...
X_matrix = df_class %>%
  dplyr::select(-c(AccidentSeverityCategory, AccidentSeverityCategory_en, fatalties, severe_injuries, light_injuries))
